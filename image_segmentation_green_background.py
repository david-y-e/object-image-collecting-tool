...
def Background_Removal_Green(img,threshold):
    ...
    for i in set1:
        img[0:i[0],i[1],3] = 0
        img_check[0:i[0],i[1]] = (0,0,255)

    for i in set2:
        img[i[0]:rows-1,i[1],3] = 0
        img_check[i[0]:rows-1,i[1]] = (0,0,255)

    for i in set3:
        img[i[0],0:i[1],3] = 0
        img_check[i[0], 0:i[1]] = (0,0,255)

    for i in set4:
        img[i[0],i[1]:cols-1,3] = 0
        img_check[i[0],i[1]:cols-1] = (0,0,255)

    img[0:ymin,0:xmin,3] = 0
    img_check[0:ymin,0:xmin] = (0,0,255)

    img[0:ymin,xmax:cols-1,3] = 0
    img_check[0:ymin,xmax:cols-1] = (0,0,255)

    img[ymax:rows-1,0:xmin,3] = 0
    img_check[ymax:rows-1,0:xmin] = (0,0,255)

    img[ymax:rows-1,xmax:cols-1,3] = 0
    img_check[ymax:rows-1,xmax:cols-1] = (0,0,255)
